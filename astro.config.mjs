...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        ...
        { label: 'Keys & Strings', collapsed: true, items: [{ autogenerate: { directory: 'keys-strings' } }] },
        { label: 'Lists & Hashes', collapsed: true, items: [{ autogenerate: { directory: 'lists-hashes' } }] },
        { label: 'Sets & Sorted Sets', collapsed: true, items: [{ autogenerate: { directory: 'sets-sorted-sets' } }] },
        { label: 'Pub/Sub & Streams', collapsed: true, items: [{ autogenerate: { directory: 'pubsub-streams' } }] },
        { label: 'Persistence & Expiration', collapsed: true, items: [{ autogenerate: { directory: 'persistence-expiration' } }] },
        { label: 'Patterns & Use Cases', collapsed: true, items: [{ autogenerate: { directory: 'patterns' } }] },
        { label: 'Transactions, Lua & Tooling', collapsed: true, items: [{ autogenerate: { directory: 'transactions-scripting-tooling' } }] },
      ],
      }), preact()],
});